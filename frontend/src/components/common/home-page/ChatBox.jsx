...
const ChatBox = () => {
  return (
    <div className=" border-2 rounded-xl w-full   md:min-w-3xl md:max-w-3xl rounded-ld p-2">
      {/* head  */}
      <div className="p-4 flex gap-3  items-center bg-[#0d0d0d] rounded-t-xl">
        <p className="bg-green-500 h-2 w-2 rounded-full"></p>
        <p className="text-sm text-white/60 ">FusionAI</p>
      </div>

      {/* messages conatiner  */}
      <div className="min-h-100 max-h-100 px-1 md:px-5 lg:px-8 flex flex-col gap-4 py-4 overflow-y-auto scrollbar-slim">
        <UserMessage />
        <AiMessage />
        <UserMessage />
        <AiMessage />
...
const UserMessage = () => {
  return (
    <div className="flex ml-auto justify-start gap-1 md:gap-2 lg:gap-3 max-w-[80%] ">
      <div className="p-2 bg-[#1e1e1e] rounded-lg rounded-tr-xs  text-white/70 text-xs md:text-sm  ">
        {" "}
        Lorem, ipsum dolor sit amet consectetur adipisicing elit. A,
      </div>
      <img
        className="h-5 w-5 md:h-6 md:w-6 lg:h-8 lg:w-8  rounded-full"
...
const AiMessage = () => {
  return (
    <div className="flex justify-start gap-1 md:gap-2 lg:gap-3 max-w-[80%] ">
      <img
        className="h-5 w-5 md:h-6 md:w-6 lg:h-8 lg:w-8  rounded-full"
        ...
        alt=""
      />
      <div className="p-2 bg-white rounded-xl rounded-tl-xs text-black/80 text-xs md:text-sm  ">
        {" "}
        Lorem, ipsum dolor sit amet consectetur adipisicing elit. A,
      </div>
    </div>
